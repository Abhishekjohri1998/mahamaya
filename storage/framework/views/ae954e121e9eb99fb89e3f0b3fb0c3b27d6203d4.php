            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="token-calculation">
                        ...
                        <p class="card-text">Enter the number of <?php echo e($settings->token_symbol); ?> tokens you want to purchase. The ETH amount will be calculated automatically.</p>
                        
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <label for="metamask-token-amount" class="form-label">Number of <?php echo e($settings->token_symbol); ?> Tokens</label>
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text bg-primary text-white"><?php echo e($settings->token_symbol); ?></span>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <button class="btn btn-outline-primary btn-sm mr-2 mb-2" onclick="setTokenAmount(100)">100 <?php echo e($settings->token_symbol); ?></button>
                                <button class="btn btn-outline-primary btn-sm mr-2 mb-2" onclick="setTokenAmount(500)">500 <?php echo e($settings->token_symbol); ?></button>
                                <button class="btn btn-outline-primary btn-sm mr-2 mb-2" onclick="setTokenAmount(1000)">1,000 <?php echo e($settings->token_symbol); ?></button>
                                <button class="btn btn-outline-primary btn-sm mr-2 mb-2" onclick="setTokenAmount(5000)">5,000 <?php echo e($settings->token_symbol); ?></button>
                                <button class="btn btn-outline-primary btn-sm mr-2 mb-2" onclick="setTokenAmount(10000)">10,000 <?php echo e($settings->token_symbol); ?></button>
                            </div>
                        </div>
                ...
                <div class="col-12 mb-3">
                    <div class="text-white card bg-primary">
                        <div class="card-body text-center">
                            ...
                            <h2 class="mt-0 mb-0"><?php echo e(number_format(Auth::user()->tot_tk_bal)); ?></h2>
                            <small><?php echo e($settings->token_symbol); ?> Tokens</small>
                        </div>
                    </div>
                </div>
...
<?php /**PATH D:\Mahamaya\mahamaya\resources\views/livewire/buy-token.blade.php ENDPATH**/ ?>