...
} elseif ($_instance->childHasBeenRendered('qNuHjHQ')) {
    $componentId = $_instance->getRenderedChildComponentId('qNuHjHQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('qNuHjHQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qNuHjHQ');
} else {
    $response = \Livewire\Livewire::mount('profile.two-factor-authentication-form');
    $html = $response->html();
    $_instance->logRenderedChild('qNuHjHQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                </div>
