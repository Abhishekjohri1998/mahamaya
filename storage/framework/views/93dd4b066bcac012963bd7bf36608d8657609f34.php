...
} elseif ($_instance->childHasBeenRendered('RoIVpY6')) {
    $componentId = $_instance->getRenderedChildComponentId('RoIVpY6');
    $componentTag = $_instance->getRenderedChildComponentTagName('RoIVpY6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RoIVpY6');
} else {
    $response = \Livewire\Livewire::mount('transfer-token', []);
    $html = $response->html();
    $_instance->logRenderedChild('RoIVpY6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<!-- /deposit Modal --><?php /**PATH D:\Mahamaya\mahamaya\resources\views/user/modal.blade.php ENDPATH**/ ?>