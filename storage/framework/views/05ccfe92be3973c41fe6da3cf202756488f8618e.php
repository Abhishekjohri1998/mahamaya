...
<?php $__env->startSection('content'); ?>
    ...
    <div class="main-panel bg-<?php echo e($bg); ?>">
        <div class="content bg-<?php echo e($bg); ?>">
            <div class="page-inner bg-<?php echo e($bg); ?>">
                <div class="mt-2 mb-4">
                                    ...
                                    <div class="p-3 col-12 col-stats">
                                        <div class="text-white numbers">
                                            ...
                                            <h4 class="card-title text-white">
                                                ...
                                                <?php endif; ?>
                                                <?php echo e($settings->token_symbol); ?>
                        ...
                        <div class="card card-round bg-<?php echo e($bg == 'light' ? 'white' : 'dark'); ?> border-<?php echo e($bg == 'light' ? 'light' : 'secondary'); ?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="p-3 col-12 col-stats">
                                        <div class="numbers">
                                            <h3 class="mb-3 card-category text-bold text-<?php echo e($text); ?>">Your Account Status</h3>
                                            <?php if(Auth::user()->email_verified_at): ?>
                                            <a href="#" class="p-2 mr-2 btn btn-success btn-sm">Email Verified</a>
                                            <?php else: ?>
                                            <a href="#" class="p-2 mr-2 btn btn-sm text-white bg-danger">Email not Verified</a>
                                            <?php endif; ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="p-3 col-md-3">
                                        <img src="<?php echo e(asset('storage/app/public/'. $settings->logo)); ?>" class="img-fluid" style="max-width: 125px;"> 
                                    </div> 
                                    <div class="p-3 col-md-9">
                                        <h3 class="text-<?php echo e($text); ?>">Thank you for choosing <?php echo e($settings->site_name); ?></h3>
