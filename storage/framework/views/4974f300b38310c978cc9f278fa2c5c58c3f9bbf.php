                        ...
                        <div class="text-center mb-4">
                            ...
                            <?php if($settings->logo): ?>
                                <img class="auth__logo img-fluid" 
                                    src="<?php echo e(asset('storage/'. $settings->logo)); ?>" alt="<?php echo e($settings->site_name); ?>">
                            <?php else: ?>
                                <h2 class="auth__logo text-center"><?php echo e($settings->site_name); ?></h2>
                            <?php endif; ?>
                        </a>
...
<?php /**PATH D:\Mahamaya\mahamaya\resources\views/auth/adminlogin.blade.php ENDPATH**/ ?>