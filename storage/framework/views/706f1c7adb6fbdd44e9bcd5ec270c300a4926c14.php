...
} elseif ($_instance->childHasBeenRendered('8xvYTdm')) {
    $componentId = $_instance->getRenderedChildComponentId('8xvYTdm');
    $componentTag = $_instance->getRenderedChildComponentTagName('8xvYTdm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8xvYTdm');
} else {
    $response = \Livewire\Livewire::mount('admin.send-message-all', []);
    $html = $response->html();
    $_instance->logRenderedChild('8xvYTdm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                    </div>
